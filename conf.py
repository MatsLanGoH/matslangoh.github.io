...
BLOG_AUTHOR = "Matthias Lambrecht"  # (translatable)
BLOG_TITLE = "The Pym Particle"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://matslangoh.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://matslangoh.github.io/"
BLOG_EMAIL = "mats.lan.pod+pym@googlemail.com"
BLOG_DESCRIPTION = "No one ever reads the instructions."  # (translatable)
